...
@Service
@AllArgsConstructor
public class DiscordChannelLanguageUnlinkCommand implements CommandHandler {

    public static final String CMD = "discord-channel-language-unlink";
    ...
    public Mono<Void> onEvent(ChatInputInteractionEvent e) {
        ...
        var channelGroup = e.getOptionAsString("channel_group").orElseThrow(() -> new IllegalArgumentException("channel_group is mandatory"));
        ...
        return DiscordBotImpl.executeBlocking(() -> discordService.removeDiscordServerChannelLanguage(channelGroup, serverId, channel)) //
